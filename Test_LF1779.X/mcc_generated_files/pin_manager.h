...
#define LED_OD                ODCONDbits.ODD3
#define LED_ANS                ANSELDbits.ANSD3
...
#define LED_SetPushPull()    do { ODCONDbits.ODD3 = 1; } while(0)
#define LED_SetOpenDrain()   do { ODCONDbits.ODD3 = 0; } while(0)
#define LED_SetAnalogMode()  do { ANSELDbits.ANSD3 = 1; } while(0)
#define LED_SetDigitalMode() do { ANSELDbits.ANSD3 = 0; } while(0)
