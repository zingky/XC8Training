...
// get/set BT1 aliases
#define BT1_TRIS               TRISBbits.TRISB7
#define BT1_LAT                LATBbits.LATB7
#define BT1_PORT               PORTBbits.RB7
#define BT1_WPU                WPUBbits.WPUB7
#define BT1_SetHigh()            do { LATBbits.LATB7 = 1; } while(0)
#define BT1_SetLow()             do { LATBbits.LATB7 = 0; } while(0)
#define BT1_Toggle()             do { LATBbits.LATB7 = ~LATBbits.LATB7; } while(0)
#define BT1_GetValue()           PORTBbits.RB7
#define BT1_SetDigitalInput()    do { TRISBbits.TRISB7 = 1; } while(0)
#define BT1_SetDigitalOutput()   do { TRISBbits.TRISB7 = 0; } while(0)
#define BT1_SetPullup()      do { WPUBbits.WPUB7 = 1; } while(0)
#define BT1_ResetPullup()    do { WPUBbits.WPUB7 = 0; } while(0)
