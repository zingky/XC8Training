...
// get/set Y aliases
#define Y_TRIS               TRISBbits.TRISB3
#define Y_LAT                LATBbits.LATB3
#define Y_PORT               PORTBbits.RB3
#define Y_WPU                WPUBbits.WPUB3
#define Y_ANS                ANSELBbits.ANSB3
#define Y_SetHigh()            do { LATBbits.LATB3 = 1; } while(0)
#define Y_SetLow()             do { LATBbits.LATB3 = 0; } while(0)
#define Y_Toggle()             do { LATBbits.LATB3 = ~LATBbits.LATB3; } while(0)
#define Y_GetValue()           PORTBbits.RB3
#define Y_SetDigitalInput()    do { TRISBbits.TRISB3 = 1; } while(0)
#define Y_SetDigitalOutput()   do { TRISBbits.TRISB3 = 0; } while(0)
#define Y_SetPullup()      do { WPUBbits.WPUB3 = 1; } while(0)
#define Y_ResetPullup()    do { WPUBbits.WPUB3 = 0; } while(0)
#define Y_SetAnalogMode()  do { ANSELBbits.ANSB3 = 1; } while(0)
#define Y_SetDigitalMode() do { ANSELBbits.ANSB3 = 0; } while(0)
