...
// get/set nCS1 aliases
#define nCS1_TRIS               TRISCbits.TRISC6
#define nCS1_LAT                LATCbits.LATC6
#define nCS1_PORT               PORTCbits.RC6
#define nCS1_SetHigh()            do { LATCbits.LATC6 = 1; } while(0)
#define nCS1_SetLow()             do { LATCbits.LATC6 = 0; } while(0)
#define nCS1_Toggle()             do { LATCbits.LATC6 = ~LATCbits.LATC6; } while(0)
#define nCS1_GetValue()           PORTCbits.RC6
#define nCS1_SetDigitalInput()    do { TRISCbits.TRISC6 = 1; } while(0)
#define nCS1_SetDigitalOutput()   do { TRISCbits.TRISC6 = 0; } while(0)

// get/set nCS2 aliases
#define nCS2_TRIS               TRISCbits.TRISC7
#define nCS2_LAT                LATCbits.LATC7
#define nCS2_PORT               PORTCbits.RC7
#define nCS2_SetHigh()            do { LATCbits.LATC7 = 1; } while(0)
#define nCS2_SetLow()             do { LATCbits.LATC7 = 0; } while(0)
#define nCS2_Toggle()             do { LATCbits.LATC7 = ~LATCbits.LATC7; } while(0)
#define nCS2_GetValue()           PORTCbits.RC7
#define nCS2_SetDigitalInput()    do { TRISCbits.TRISC7 = 1; } while(0)
#define nCS2_SetDigitalOutput()   do { TRISCbits.TRISC7 = 0; } while(0)
